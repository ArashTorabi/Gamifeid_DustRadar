package edu.teco.gamifieddustradar.http;

import java.net.URISyntaxException;

import edu.teco.gamifieddustradar.data.DataObject;
import edu.teco.gamifieddustradar.sensorthings.Datastream;
import edu.teco.gamifieddustradar.sensorthings.FeatureOfInterest;
import edu.teco.gamifieddustradar.sensorthings.Observation;
import edu.teco.gamifieddustradar.sensorthings.ObservedProperty;
import edu.teco.gamifieddustradar.sensorthings.Sensor;
import edu.teco.gamifieddustradar.sensorthings.Thing;
import edu.teco.gamifieddustradar.sensorthings.geojson.GeoPoint;
import edu.teco.gamifieddustradar.sensorthings.helper.UnitOfMeasurement;
